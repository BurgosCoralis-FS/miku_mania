...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      fixed top-0 z-20 bg-primary-400 bg-opacity-10
    `}
          ...
          {navLinks.map((link) => {
            return (
              <li
                ...
                } hover:text-primary-800 text-[18px] font-medium cursor-pointer `}
              ...
              {navLinks.map((link) => {
                return (
                  <li
                    ...
                    className={`${
                      active === link.title ? "text-white" : "text-secondary"
                    } font-poppins font-medium cursor-pointer text-[16px] text-grayscale-50`}
                    onClick={() => {
